...
{var r=this.radius;if(prop.align==='left'){var x=this.markerCenterx,y=this.markerCentery;this.path('a % % % % % false',x,y,r,RGraph.HALFPI,RGraph.TWOPI);this.path('qc % % % %',x+r,y+r,x+r+r,y+r+r);this.path('qc % % % %',x+r,y+r,x,y+r);}else if(prop.align==='right'){var x=this.markerCenterx,y=this.markerCentery;this.path('a % % % % % true',x,y,r,RGraph.HALFPI,RGraph.PI);this.path('qc % % % %',x-r,y+r,x-r-r,y+r+r);this.path('qc % % % %',x-r,y+r,x,y+r);}else{var x=this.markerCenterx,y=this.markerCentery;this.path('a % % % % % true',x,y,r,RGraph.HALFPI/2,RGraph.PI-(RGraph.HALFPI/2));this.path('qc % % % %',x,y+r+(r/4),x,y+r+r-2);this.path('qc % % % %',x,y+r+(r/4),x+(Math.cos(RGraph.HALFPI/2)*r),y+(Math.sin(RGraph.HALFPI/2)*r));}
